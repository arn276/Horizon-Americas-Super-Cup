...
for game in schedule_conf1:
    if game[1] == '':
        ...
        randomList = random.choices(game[1:]+['tie'], weights=(homeWt, awayWt,extrasRate), k=1)
        commonWinnerSelection = max(set(randomList), key=randomList.count)
        results_conf1.append(game+[commonWinnerSelection])
