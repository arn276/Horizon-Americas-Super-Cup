...
for i in range(100):
    ...
    scheduleToStore = schedule_conf1_t+schedule_conf2_t
    scheduleToStore = [ [number]+x for x in scheduleToStore]
    ...
    teamStength = [
        ...
        ['Oakland', 0.565],['Los Angeles', 0.601],['Phoenix', 0.571],['Tijuana', 0.472]
        ]
